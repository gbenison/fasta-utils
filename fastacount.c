...
void init_sequence(void) { sequence_length = 0; }
...
void terminate_sequence() { printf("%d\n", sequence_length); }
void init_comment() { comment_length = 0; printf("> "); }
void handle_comment(char c) { ++comment_length; putchar(c); }
